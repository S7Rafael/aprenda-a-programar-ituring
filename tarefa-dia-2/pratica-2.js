...
if (a == 10) {
    ...
    console.log("Falso! O valor ", a, " não é igual a 10");'if'
}
...
if (10 <= a) {
    ...
    console.log("Falso! O valor ", a, "não é maior ou igual a 10");'if'
}
...
if (b == true) {
    ...
    console.log("Falso! O valor ", b, " não é igual a true");'if'
}
...
if (b) {
    ...
    console.log("Falso! O valor ", b, " não é considerado como verdade");'if'
}
...
if (c) {
    ...
    console.log("Falso! O valor ", c, " não é considerado como verdade");'if'
}
...
if (d) {
    ...
    console.log("Falso! O valor ", d, " não é considerado como verdade");'if'
}
...
if (d[0] == 1) {
    ...
    console.log("Falso! O valor ", d[0], " do elemento do índice 0 da variável 'd' não é igual a 1");'if'
}
...
if (typeof(e) == 'string') {
    ...
    console.log("Falso! O tipo de dado da variável 'e' não é uma string");'if'
}